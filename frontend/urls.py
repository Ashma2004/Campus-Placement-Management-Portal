...
from .views import main, admin_login, student_login,student_registration,student_dashboard,student_profile,admin_dashboard,view_registered_students,post_drives,application_form,available_drives,applied_students,post_selected_students,selected_students,admin_selected_students,logout
urlpatterns = [   
    path('', main, name='main'),
