...
# 2. Logic for the Gallery
def selected_students(request):
    students = SelectedStudent.objects.all()
    return render(request, 'frontend/selected_students.html', {'students': students})
def admin_selected_students(request):
    students = SelectedStudent.objects.all()
    return render(request, 'frontend/admin_selected_students.html', {'students': students})
